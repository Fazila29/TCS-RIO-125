...
public class Agent {
	...
	public WebElement aghotelscity2;
	@FindBy(xpath="//span[@class='select2-search select2-search--dropdown']/following-sibling::span//child::ul//child::i")
