...
driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);	
    ...
    String expectedURL =AutomationConstants.CFURL5;
	  String actualURL =driver.getCurrentUrl();
	  Assert.assertEquals(expectedURL,actualURL);
	  System.out.println("CF-Test11 passed;Add Funds page opened");
	    Thread.sleep(2000);
	    }
	    ...
	    @Test(priority=12)
	     public void verifyPayment() throws IOException, Exception {
	    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	    objCFDashboard= new CFDashboard(driver);
  ...
  // objCFDashboard.viewpaynow();
   ...
   // driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
    ...
    String expectedURL1 =AutomationConstants.CFURL6;
	  String actualURL1 =driver.getCurrentUrl();
	  Assert.assertEquals(expectedURL1,actualURL1);
	  System.out.println("CF-Test 12-A passed;PayPal payment page opened");
	    Thread.sleep(3000);
	    objCFDashboard.clickBacktoInvoice();
	    Thread.sleep(2000);
	    objCFDashboard.clickYes();
	    Thread.sleep(3000);
	    String expectedURL11 =AutomationConstants.CFURL5;
		  String actualURL11 =driver.getCurrentUrl();
		  Assert.assertEquals(expectedURL11,actualURL11);
		  System.out.println("CF-Test 12b passed;Returned to add funds page ");
		  Thread.sleep(2000);
...
driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);	
    ...
    String expectedURL =AutomationConstants.CFURL9;
	  String actualURL =driver.getCurrentUrl();
	  Assert.assertEquals(expectedURL,actualURL);
	  System.out.println("Successfully Logged Out, Test13 passed ");
	    Thread.sleep(2000);
